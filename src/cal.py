...
datenow = input("You must enter a month using 1-12 [space] and year (ie. 2017): ").split()
...
if len(datenow) == 0:
    ...
    print('You must enter a number between 1 and 12 for the first number. And then [space] and year format.')
